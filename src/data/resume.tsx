...
import { HomeIcon, NotebookIcon, MailIcon, X } from "lucide-react";

export const DATA = {
  name: "Amol Yadav",
  initials: "AMY",
  url: "https://amolyadav.site",
  location: "Mumbai, MH",
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/amyssnippet",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://linkedin.com/in/yadav-amol",
        icon: Icons.linkedin,
      ...
      Youtube: {
        name: "Youtube",
        url: "https://youtube.com/@amycode",
        icon: Icons.youtube,
        navbar: true,
      },
      email: {
        name: "Send Email",
        url: "mailto:contact@amolyadav.site",
        icon: Icons.email,
  ...
  education: [
    ...
    {
      school: "SVP Junior College of Science",
      href: "https://svpjc.in",
      degree: "Grade 11 & 12",
      logoUrl: "/SVPV-4-COLOR-LOGO-SMALL-2.png",
      start: "2021",
      end: "2023",
    },
    {
      school: "Blossomms High School",
      href: "https://blossommshighschool.in/",
      degree: "Grade 3 - 10",
      logoUrl: "/IMG_20240829_133039.png",
      start: "2013",
      end: "2021",
    },
    {
      school: "KES International School",
      href: "https://kesinternationalschool.org",
      degree: "K - Grade 2",
      logoUrl: "/footer-logo-1024x647-1-980x619.png",
      start: "2008",
      end: "2013",
    },
  ],
  projects: [
    
    {
      ...
      active: true,
      description: "Wavyy is a platform which connects Users and Salon Businesses interactively giving Salons a better connectivity with their clients",
      technologies: [
        "React JS",
        "Django",
        "TailwindCSS",
      ...
      image: "",
      video: "https://os-imgs.vercel.app/Screencast%20from%202025-01-27%2021-47-13.mp4",
    },
    {
      title: "Schema doc",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/bradcn/schema-documentation-template/",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
      video: "https://bradmedia.vercel.app/tutorial.mp4.mp4",
    },
  ],
  hackathons: [
    {
