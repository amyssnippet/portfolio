...
import { HomeIcon, NotebookIcon, Trophy } from "lucide-react";
...
export const DATA = {
  ...
  avatarUrl: "/PSX_20240219_195257.jpg",
  skills: [
    "React",
    "Next.js",
    "Typescript",
  ...
  navbar: [
    ...
    { href: "/certificates", icon: Trophy, label: "Certificates" },
  ],
  contact: {
